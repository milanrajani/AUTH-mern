                    ...
                    <div className="card-body p-4 text-center">
                        ...
                        <form action="">
                            ...
                            <div className="form-outline Form-white mb-4">
                                ...
                                <input type="email" id="email" placeholder='Email' className="form-control Form-control-lg" required/>
                            </div>
                            <div className="form-outline  Form-white mb-4">
                                {/* <label htmlFor="password" className="form-label fw-bold">Password:</label> */}
                                <input type="password" name="password" id="password" placeholder='Password' className="form-control Form-control-lg" required/>
                            </div>
